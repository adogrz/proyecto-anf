...
interface ImportCuentasBaseModalProps {
    ...
    isOpen: boolean;
    onClose: () => void;
    empresa: Empresa; // Added actual empresa prop
}

export default function ImportCuentasBaseModal({ plantilla, isOpen, onClose, empresa }: ImportCuentasBaseModalProps) {
    ...
    const handleImport = async () => {
        ...
        formData.append('empresa_id', empresa.id.toString()); // Use actual empresa.id here
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[900px] h-[90vh] flex flex-col">
                <DialogHeader>
                    <DialogTitle>Importar Cuentas Base para {plantilla.nombre}</DialogTitle>
                    <DialogDescription>
                        Arrastre y suelte su catálogo base en formato Excel (.xlsx, .xls, .csv) en el área designada o haga clic para seleccionarlo. Este catálogo definirá la estructura estándar de cuentas para la empresa.
                    </DialogDescription>
                </DialogHeader>
                <div className="flex-grow overflow-auto p-4"> {/* Added padding */}
                    <Card>
                        ...
                        <CardFooter className="flex justify-end"> {/* Removed onBack button */}
